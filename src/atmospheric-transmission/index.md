...
Left alone, the figure starts with the first group alone, an atmosphere with no greenhouse gases, and adds those one at a time: water vapour, carbon dioxide, methane, nitrous oxide. Press anything and the tour stops; *Play tour* starts it again. Tick a row to include that constituent or leave it out (every combination is a few clicks: untick everything but carbon dioxide, say); the segmented controls set the amount of water vapour (a dry polar column, the global mean, or the humid tropics) and of carbon dioxide, methane and nitrous oxide (1750, today, or double today's), and the slider moves the Earth's surface temperature. Hover or touch the figure to read the absorption at any wavelength.
...
display(embedSnippets({
  ...
  note: "The figure is a fixed 640&nbsp;px tall; the rest is the controls and the read-out, " +
    "which wrap onto more rows as the frame narrows. The height above suits a frame " +
    "640&nbsp;px wide or more; allow about 950&nbsp;px at phone width. The embed page accepts " +
